...
class RrtHistory extends Component
{
    ...
    public $menstrual;
    public $dailysisAccessMenu;
    public $siteofavf, $siteofcather, $hdfreq;
    ...
    public function __construct(public string $type)
    {
        ...
        $this->dailysisAccessMenu = array('Select', 'AVF', 'Tunnel HD catheter');
        ...
        $this->siteofavf = array('Select', 'Brachial', 'Radial');
        $this->siteofcather = array('Select', 'IJV', 'EJV');
        $this->hdfreq = array('Select', 'Twice a week', 'Thrice a week', 'Alternate day');
    ...
    {
        return view('components.new.rrt-history');
    }
}
